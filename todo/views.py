...
def index(request):
    ...
    # resolved error -> Field 'id' expected a number but got <SimpleLazyObject:
    # <django.contrib.auth.models.AnonymousUser object at 0x0000026047E67A50>>.
    # refer:https://stackoverflow.com/questions/62966136/typeerror-field-id-expected-a-number-but-got-django-contrib-auth-models-anon
...
def create_todo(request):
    ...
    if request.method == "POST":
        ...
        # create a todo to be sent
        todo = Todo()
        todo.title = title
        todo.description = description
        todo.is_completed = True if is_completed == "on" else False
        todo.owner = request.user
        todo.save()  # save will return pk
